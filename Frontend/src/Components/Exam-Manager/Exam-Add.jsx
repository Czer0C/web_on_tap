...
export default class ExamAdd extends Component {
    ...
    getCorrectChoice() {
        if (this.state.choiceA.isCorrect === true) {
            return 0
        }
        if (this.state.choiceB.isCorrect === true) {
            return 1
        }
        if (this.state.choiceC.isCorrect === true) {
            return 2
        }
        if (this.state.choiceD.isCorrect === true) {
            return 3
        }
            ...
            <div className="product-page">
                <div className="section section-gray">
                    <div className="container">
                        ...
                        <NavLink className="nav-link pull-left" activeClassName="nav-link active" to="/admin">
